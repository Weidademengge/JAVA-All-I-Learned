...
/**
 * @author duym
 * @version $ Id: BSTreeTest, v 0.1 2023/05/11 15:35 duym Exp $
 */
public class BSTreeTest {
    public static void main(String[] args) {
        ...
        print(bsTree.getRoot());
    }

    public static void print(BSTree.BSTNode root) {
        if (root == null) {
            return;
        }
    ...
    private static void writeArray(BSTree.BSTNode currNode, int rowIndex, int columnIndex, String[][] res, int height) {
        // 保证输入的树不为空
        if (currNode == null) {
            return;
        }
    ...
    public static int maxDepth(BSTree.BSTNode root) {
        if (root == null) {
            return 0;
        } else {
